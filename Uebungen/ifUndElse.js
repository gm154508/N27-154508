...
//Excel: 
//A1:1 Der Wert 1 wird in der Zelle A1 getippt
//B1:2 Der Wert 2 wird in der Zelle B1 getippt
//C1: =wenn(A1=B1;"gleich";"ungleich")

//Javascript

let a1 = 15 //Eine Variable (z.B. a1 oder zahl1) wird mit dem Wert 1 initialisiert
let b1 = 15 //Eine variable (z.B. b1 oder zahl2) wird mit dem Wert 2 initialisiert
...
//Erkenntnisgewinn: Mit dem einfachen Gleichheitszeichen wird ein Wert von rechts nach links 
//zugewiesen. Mit dem doppelten Gleichheitszeichen werden zwei Werte auf Wert-Gleichheit geprüft. 
//Mit dem dreifachen Gleichheitszeichen werden zwei Werte auf Wert- und Typ-Gleichheit geprüft.
...
let einwohnerKöln =    1000000

if (einwohnerBerlin>einwohnerKöln){
...
//Erkenntsnisgewiin: Wenn der Ausdruck (hier: lebensmittel) true oder false ist, 
...
console.log("Übung 10 - Die Prüfung von Zahlen:")
